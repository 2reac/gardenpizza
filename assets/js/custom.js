...
jQuery(function ($) {
  ...
  jQuery('.scrollToTop').click(function () {
    jQuery('html, body').animate({ scrollTop: 0 }, 999);
    return false;
  });
  ...
  if ("ontouchstart" in document.documentElement) {
    $(".gp-about-us-left img").click(function () {
      $(".gp-about-us-left img.top").toggleClass("transparent");
    });
  }
  else {
    $(".gp-about-us-left img").hover(function () {
      $(".gp-about-us-left img.top").toggleClass("transparent");
    });
  }
